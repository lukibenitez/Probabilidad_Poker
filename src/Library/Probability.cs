namespace Poker
{
    public class Probability
    {
        ...
        public double probabilityOfFullHouse(Repartidora repartidora)
        {
            ...
            {
                mediumProbability =  ( (2) * ((Maths.Combinaciones(3,2) * Maths.Combinaciones(3, 1) * Maths.Combinaciones(47, 2))/(Maths.Combinaciones(50, 5))) );
            ...
            {
                mediumProbability = (Maths.Combinaciones(4, 3) * Maths.Combinaciones(44, 2) ) / (Maths.Combinaciones(50,5));
            }
            finalProbability = (inicialProbability + mediumProbability) * 100;
            return finalProbability;
        }
